...
Returns: data{ resolvedName, description, industryCandidates[], offeringCandidates[], suggestedKeywords[], brandKeywords[], defaultPlatforms[](7个社媒), optionalPlatforms[](threads/reddit,同价), depthOptions[]{tier,maxPages,eta,approxPostsPerPlatform,estimatedPoints}, nextStep }。
...
Returns: data{ resolvedName, description, industryCandidates[], offeringCandidates[], suggestedKeywords[], brandKeywords[], defaultPlatforms[](7 social), optionalPlatforms[](threads/reddit, same price), depthOptions[]{tier,maxPages,eta,approxPostsPerPlatform,estimatedPoints}, nextStep }.

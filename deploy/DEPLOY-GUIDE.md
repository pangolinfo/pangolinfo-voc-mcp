# DataScaler VOC MCP v0.3.3 — 阿里云 ACK 部署手册
...
scripts\window\deploy-mcp.cmd 0.3.3
```
...
```
[pangolinfo-datascaler-mcp] locale=en version=0.3.3
...
# 期望: {"status":"ok","version":"0.3.3","toolCount":25}
